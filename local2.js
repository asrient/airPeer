...
const rudp = require("./libudp/rudp");
const message = require('./msg.js');

var peers = [];
var addrBook = {};

const frameSize = 50000//64535;
    ...
    start: function (uid, host, app, name) {
        ...
        this.socket.on('message', (msg, rinfo) => {
                ...
                if (airId != null) {
                    ...
                    console.log("got a msg from unknown address", rinfo.address + ':' + rinfo.port, m.type,m.to,m.body.length);
                }
            }
            var feed = msg;
            ...
            parsedFrame.chunks.forEach((chunk) => {
                ...
                if (this.ongoing[key] != undefined) {
                    ...
                    console.log("storing chunk",this.ongoing[key].count, ' size: '+data.length);
